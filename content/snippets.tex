...
\subsection{Cite}\label{subsec:cite}

Blablabla \cite{bellman57}.
...
\begin{figure}
    \centering
    \ifpdf
    \includegraphics[width=.80\linewidth]{figs/test.pdf}
    \else
    \imgsrc{figs/test.png}
    \fi
...
\begin{figure}
    ...
    \subfloat{
        \ifpdf
        \includegraphics[width=.30\linewidth,height=.20\linewidth]{figs/test}
        \else
        \imgsrc{figs/test.png}
        \fi
    }~
